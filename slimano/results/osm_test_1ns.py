...
def run(name):
    ...
    nsi_id = osmc.schedule_nsi_instantiation('k8s_nst', 'k8s_nsi', 'openstack-atnog-4')

    osmc.instantiate_nsi('k8s_nst', 'k8s_nsi', nsi_id, 'openstack-atnog-4')
...
if __name__ == '__main__':
    ...
    run_nr = 1
    while run_nr <= runs:
        run('test_osm_1ns_{}'.format(run_nr))
        run_nr = run_nr + 1

...
def run(name):
    ...
    nsi_id = osmc.schedule_nsi_instantiation('k8s_nst10', 'k8s_nsi10', 'openstack-atnog')

    osmc.instantiate_nsi('k8s_nst10', 'k8s_nsi10', nsi_id, 'openstack-atnog')
...
if __name__ == '__main__':
    ...
    run_nr = 1
    while run_nr <= runs:
        run('test_osm_10ns_{}'.format(run_nr))
        run_nr = run_nr + 1
